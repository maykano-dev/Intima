  ...
  return (
    <section className="hero-section">
      <div className="hero-left">
        <p className="text-[0.72rem] tracking-[0.2em] uppercase text-primary mb-6 animate-[fadeUp_0.8s_0.3s_forwards]">
          Ghana&apos;s Discreet Wellness Store
        </p>
        <h1 className="font-serif text-[clamp(3rem,5vw,5.5rem)] font-light leading-[0.95] text-accent mb-6 animate-[fadeUp_0.8s_0.5s_forwards]">
          Your wellness,<br />
          your <em className="italic text-primary">privacy,</em><br />
          delivered.
        </h1>
        <p className="text-base leading-[1.8] text-muted max-w-[380px] mb-12 animate-[fadeUp_0.8s_0.7s_forwards]">
        ...
        <div className="flex gap-4 items-center animate-[fadeUp_0.8s_0.9s_forwards]">
        ...
        <div className="flex gap-10 mt-16 animate-[fadeUp_0.8s_1.1s_forwards]">
          {[
            { label: 'Sourcing', val: 'Global & Local' },
